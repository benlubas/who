...
var app = (function () {
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$b, 112, 0, 3345);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$a, 6, 2, 183);
    			attr_dev(a, "href", a_href_value = /*$url*/ ctx[1]("/"));
    			add_location(a, file$a, 14, 2, 350);
    			add_location(br0, file$a, 15, 2, 394);
    			add_location(br1, file$a, 15, 8, 400);
    			attr_dev(div1, "class", "title-container");
    			add_location(div1, file$a, 5, 0, 150);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$9, 14, 6, 579);
    			add_location(br0, file$9, 22, 6, 1155);
    			add_location(br1, file$9, 23, 6, 1169);
    			add_location(br2, file$9, 26, 6, 1335);
    			add_location(br3, file$9, 27, 6, 1349);
    			add_location(br4, file$9, 31, 6, 1576);
    			add_location(br5, file$9, 32, 6, 1590);
    			add_location(br6, file$9, 38, 6, 1919);
    			add_location(br7, file$9, 39, 6, 1933);
    			attr_dev(div1, "class", "subtitle");
    			add_location(div1, file$9, 45, 6, 2287);
    			attr_dev(a0, "href", "https://www.svelte.dev");
    			add_location(a0, file$9, 50, 6, 2651);
    			add_location(br8, file$9, 51, 6, 2726);
    			add_location(br9, file$9, 52, 6, 2740);
    			add_location(br10, file$9, 57, 6, 3060);
    			add_location(br11, file$9, 57, 12, 3066);
    			attr_dev(a1, "href", "https://routify.dev");
    			add_location(a1, file$9, 60, 6, 3236);
    			add_location(br12, file$9, 64, 6, 3524);
    			add_location(br13, file$9, 64, 12, 3530);
    			attr_dev(a2, "href", "https://www.github.com/benlubas/who");
    			add_location(a2, file$9, 68, 6, 3646);
    			attr_dev(div2, "class", "subtitle");
    			add_location(div2, file$9, 70, 6, 3711);
    			add_location(br14, file$9, 78, 6, 4320);
    			add_location(br15, file$9, 79, 6, 4334);
    			attr_dev(a3, "href", a3_href_value = /*$url*/ ctx[0]("/projects"));
    			add_location(a3, file$9, 81, 10, 4436);
    			attr_dev(div3, "class", "subtitle");
    			add_location(div3, file$9, 83, 6, 4493);
    			add_location(br16, file$9, 93, 6, 5170);
    			add_location(br17, file$9, 94, 6, 5184);
    			add_location(br18, file$9, 100, 6, 5526);
    			add_location(br19, file$9, 101, 6, 5540);
    			attr_dev(a4, "href", a4_href_value = /*$url*/ ctx[0]("/courses"));
    			add_location(a4, file$9, 103, 6, 5619);
    			attr_dev(div4, "class", "text");
    			add_location(div4, file$9, 8, 4, 199);
    			add_location(div5, file$9, 5, 2, 153);
    			attr_dev(div6, "class", "page-cont");
    			add_location(div6, file$9, 4, 0, 126);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "subtitle");
    			add_location(div0, file$8, 11, 6, 399);
    			attr_dev(div1, "class", "projectTitle svelte-r9uva9");
    			add_location(div1, file$8, 12, 6, 454);
    			add_location(br0, file$8, 14, 58, 643);
    			attr_dev(div2, "class", "projectTitle svelte-r9uva9");
    			add_location(div2, file$8, 16, 6, 659);
    			add_location(br1, file$8, 18, 52, 856);
    			attr_dev(div3, "class", "projectTitle svelte-r9uva9");
    			add_location(div3, file$8, 20, 6, 872);
    			add_location(br2, file$8, 21, 61, 999);
    			attr_dev(div4, "class", "subtitle");
    			add_location(div4, file$8, 23, 6, 1015);
    			add_location(br3, file$8, 30, 6, 1456);
    			attr_dev(div5, "class", "projectTitle svelte-r9uva9");
    			add_location(div5, file$8, 31, 6, 1470);
    			add_location(br4, file$8, 32, 6, 1521);
    			add_location(br5, file$8, 43, 6, 2131);
    			attr_dev(div6, "class", "projectTitle svelte-r9uva9");
    			add_location(div6, file$8, 44, 6, 2145);
    			add_location(br6, file$8, 45, 6, 2197);
    			add_location(br7, file$8, 53, 6, 2670);
    			add_location(br8, file$8, 54, 6, 2684);
    			attr_dev(div7, "class", "subtitle");
    			add_location(div7, file$8, 59, 6, 2938);
    			add_location(br9, file$8, 63, 6, 3095);
    			attr_dev(div8, "class", "projectTitle svelte-r9uva9");
    			add_location(div8, file$8, 64, 6, 3109);
    			add_location(br10, file$8, 65, 6, 3166);
    			attr_dev(div9, "class", "text");
    			add_location(div9, file$8, 6, 4, 165);
    			add_location(div10, file$8, 4, 2, 115);
    			attr_dev(div11, "class", "page-cont");
    			add_location(div11, file$8, 3, 0, 88);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    /* src\components\textCarosel.svelte generated by Svelte v3.42.6 */
    const file$7 = "src\\components\\textCarosel.svelte";
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$7, 7, 2, 202);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    /* src\components\gridBoxes\name.svelte generated by Svelte v3.42.6 */
    const file$6 = "src\\components\\gridBoxes\\name.svelte";
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$6, 3, 0, 83);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$4, 4, 4, 81);
    			attr_dev(div1, "class", "box svelte-7o6svk");
    			add_location(div1, file$4, 3, 2, 58);
    			attr_dev(div2, "class", "container svelte-7o6svk");
    			add_location(div2, file$4, 2, 0, 31);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$3, 4, 4, 93);
    			attr_dev(div1, "class", "clip-border box svelte-1phy0f");
    			add_location(div1, file$3, 3, 2, 58);
    			attr_dev(div2, "class", "container svelte-1phy0f");
    			add_location(div2, file$3, 2, 0, 31);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file, 6, 2, 151);
    			attr_dev(div1, "class", "item svelte-1fvmdz1");
    			add_location(div1, file, 7, 2, 206);
    			attr_dev(div2, "class", "item svelte-1fvmdz1");
    			add_location(div2, file, 8, 2, 261);
    			attr_dev(div3, "class", "page-cont");
    			add_location(div3, file, 3, 0, 88);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
