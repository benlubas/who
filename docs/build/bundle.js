    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div5, "class", "email svelte-aa5l3d");
    			...
    			attr_dev(div6, "class", "website svelte-aa5l3d");
    			...
    			attr_dev(div7, "class", "contact svelte-aa5l3d");
