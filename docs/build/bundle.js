    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			t34 = text("Gaming: ");
    			br9 = element("br");
    			t35 = text(" I mainly play Rocket League these days.");
    			t36 = space();
    			li10 = element("li");
    			t37 = text("Hockey: ");
    			br10 = element("br");
    			t38 = text(" I played in high school and I still enjoy watching and skating\n        whenever I can.");
    			t39 = space();
    			li11 = element("li");
    			t40 = text("Artificial Intelligence: ");
    			br11 = element("br");
    			t41 = text(" Honestly, as time goes on I'm less interested\n        and more paying attention because it's both awe-inspiring and terrifying.");
    			t42 = space();
    			div3 = element("div");
    			...
    			t64 = space();
    			br21 = element("br");
    			t65 = text("\n\n    Additionally, this school has a co-op program, so the second semesters of my\n    second and third years, I don't have classes and I just work a full time job\n    in the CS field instead. The first co-op I took was at Wayfair, and I'm in\n    the process of searching for the second at the time of writing. You can read\n    more about how that went on the ");
    			a4 = element("a");
    			t66 = text("work page.");
    			attr_dev(div0, "class", "subtitle");
    			add_location(div0, file$b, 12, 4, 520);
    			add_location(br0, file$b, 20, 4, 1022);
    			add_location(br1, file$b, 20, 11, 1029);
    			add_location(br2, file$b, 27, 4, 1340);
    			add_location(br3, file$b, 27, 11, 1347);
    			add_location(br4, file$b, 37, 4, 1885);
    			add_location(br5, file$b, 37, 11, 1892);
    			attr_dev(div1, "class", "subtitle");
    			add_location(div1, file$b, 39, 4, 1904);
    			add_location(li0, file$b, 43, 6, 2062);
    			add_location(li1, file$b, 48, 6, 2279);
    			add_location(li2, file$b, 53, 6, 2501);
    			add_location(li3, file$b, 58, 6, 2749);
    			add_location(li4, file$b, 64, 6, 3087);
    			add_location(li5, file$b, 68, 6, 3271);
    			add_location(li6, file$b, 73, 6, 3498);
    			add_location(ul0, file$b, 42, 4, 2051);
    			attr_dev(div2, "class", "subtitle");
    			add_location(div2, file$b, 80, 4, 3747);
    			add_location(br6, file$b, 87, 8, 3959);
    			add_location(li7, file$b, 85, 6, 3927);
    			add_location(br7, file$b, 95, 8, 4363);
    			add_location(br8, file$b, 97, 30, 4489);
    			add_location(li8, file$b, 93, 6, 4334);
    			add_location(br9, file$b, 106, 18, 5106);
    			add_location(li9, file$b, 106, 6, 5094);
    			add_location(br10, file$b, 108, 16, 5185);
    			add_location(li10, file$b, 107, 6, 5164);
    			add_location(br11, file$b, 112, 33, 5335);
    			add_location(li11, file$b, 111, 6, 5297);
    			add_location(ul1, file$b, 84, 4, 3916);
    			attr_dev(div3, "class", "subtitle");
    			add_location(div3, file$b, 117, 4, 5497);
    			attr_dev(a0, "href", "https://www.svelte.dev");
    			attr_dev(a0, "target", "_blank");
    			attr_dev(a0, "rel", "noopener noreferrer");
    			add_location(a0, file$b, 122, 4, 5847);
    			add_location(br12, file$b, 127, 4, 5977);
    			add_location(br13, file$b, 127, 11, 5984);
    			add_location(br14, file$b, 133, 4, 6205);
    			add_location(br15, file$b, 133, 11, 6212);
    			attr_dev(a1, "href", "https://routify.dev");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "rel", "noopener noreferrer");
    			add_location(a1, file$b, 137, 4, 6374);
    			add_location(br16, file$b, 144, 4, 6705);
    			add_location(br17, file$b, 144, 10, 6711);
    			attr_dev(a2, "href", "https://www.github.com/benlubas/who");
    			attr_dev(a2, "target", "_blank");
    			attr_dev(a2, "rel", "noopener noreferrer");
    			add_location(a2, file$b, 148, 4, 6817);
    			attr_dev(div4, "class", "subtitle");
    			add_location(div4, file$b, 154, 4, 6943);
    			add_location(br18, file$b, 164, 4, 7639);
    			add_location(br19, file$b, 164, 11, 7646);
    			attr_dev(a3, "href", a3_href_value = /*$url*/ ctx[0]("/projects"));
    			add_location(a3, file$b, 167, 8, 7743);
    			attr_dev(div5, "class", "subtitle");
    			add_location(div5, file$b, 169, 4, 7796);
    			add_location(br20, file$b, 177, 4, 8321);
    			add_location(br21, file$b, 177, 11, 8328);
    			attr_dev(a4, "href", a4_href_value = /*$url*/ ctx[0]("/work"));
    			add_location(a4, file$b, 183, 36, 8694);
    			attr_dev(div6, "class", "text");
    			add_location(div6, file$b, 5, 2, 148);
    			attr_dev(div7, "class", "page-cont");
    			add_location(div7, file$b, 4, 0, 122);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			append_dev(div6, a1);
    			append_dev(div6, t52);
    			append_dev(div6, br16);
    			append_dev(div6, br17);
    			append_dev(div6, t53);
    			append_dev(div6, a2);
    			append_dev(div6, t55);
    			append_dev(div6, div4);
    			append_dev(div6, t57);
    			append_dev(div6, br18);
    			append_dev(div6, t58);
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file, 15, 4, 781);
    			add_location(br1, file, 19, 4, 871);
    			add_location(br2, file, 19, 10, 877);
    			add_location(li0, file, 22, 6, 900);
    			add_location(li1, file, 23, 6, 928);
    			add_location(li2, file, 24, 6, 955);
    			add_location(li3, file, 25, 6, 994);
    			add_location(li4, file, 26, 6, 1017);
    			add_location(li5, file, 27, 6, 1039);
    			add_location(li6, file, 28, 6, 1059);
    			add_location(li7, file, 29, 6, 1098);
    			add_location(ul, file, 21, 4, 889);
    			add_location(br3, file, 32, 4, 1144);
    			add_location(br4, file, 32, 10, 1150);
    			add_location(br5, file, 38, 4, 1376);
    			add_location(br6, file, 38, 10, 1382);
    			add_location(br7, file, 48, 4, 1896);
    			add_location(br8, file, 48, 10, 1902);
