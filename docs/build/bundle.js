    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br0, file$9, 18, 4, 1086);
    			add_location(br1, file$9, 19, 4, 1097);
    			add_location(br2, file$9, 22, 4, 1254);
    			add_location(br3, file$9, 23, 4, 1265);
    			add_location(br4, file$9, 27, 4, 1480);
    			add_location(br5, file$9, 28, 4, 1491);
    			add_location(br6, file$9, 34, 4, 1804);
    			add_location(br7, file$9, 35, 4, 1815);
    			attr_dev(div1, "class", "subtitle");
    			add_location(div1, file$9, 41, 4, 2153);
    			attr_dev(a0, "href", "https://www.svelte.dev");
    			add_location(a0, file$9, 46, 4, 2502);
    			add_location(br8, file$9, 47, 4, 2574);
    			add_location(br9, file$9, 48, 4, 2585);
    			add_location(br10, file$9, 53, 4, 2890);
    			add_location(br11, file$9, 53, 10, 2896);
    			attr_dev(a1, "href", "https://routify.dev");
    			add_location(a1, file$9, 56, 4, 3057);
    			add_location(br12, file$9, 60, 4, 3333);
    			add_location(br13, file$9, 60, 10, 3339);
    			attr_dev(a2, "href", "https://www.github.com/benlubas/who");
    			add_location(a2, file$9, 64, 4, 3445);
    			attr_dev(div2, "class", "subtitle");
    			add_location(div2, file$9, 66, 4, 3506);
    			add_location(br14, file$9, 74, 4, 4091);
    			add_location(br15, file$9, 75, 4, 4102);
    			attr_dev(a3, "href", a3_href_value = /*$url*/ ctx[0]("/projects"));
    			add_location(a3, file$9, 77, 8, 4198);
    			attr_dev(div3, "class", "subtitle");
    			add_location(div3, file$9, 79, 4, 4251);
    			add_location(br16, file$9, 88, 4, 4896);
    			add_location(br17, file$9, 89, 4, 4907);
    			add_location(br18, file$9, 95, 4, 5233);
    			add_location(br19, file$9, 96, 4, 5244);
    			attr_dev(a4, "href", a4_href_value = /*$url*/ ctx[0]("/courses"));
    			add_location(a4, file$9, 98, 4, 5317);
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(br2, file$8, 20, 59, 944);
    			attr_dev(div4, "class", "subtitle");
    			add_location(div4, file$8, 22, 4, 956);
    			add_location(br3, file$8, 29, 4, 1378);
    			attr_dev(div5, "class", "projectTitle svelte-r9uva9");
    			add_location(div5, file$8, 30, 4, 1389);
    			add_location(br4, file$8, 31, 4, 1437);
    			add_location(br5, file$8, 42, 4, 2018);
    			attr_dev(div6, "class", "projectTitle svelte-r9uva9");
    			add_location(div6, file$8, 43, 4, 2029);
    			add_location(br6, file$8, 44, 4, 2078);
    			add_location(br7, file$8, 52, 4, 2529);
    			add_location(br8, file$8, 53, 4, 2540);
    			attr_dev(div7, "class", "subtitle");
    			add_location(div7, file$8, 58, 4, 2781);
    			add_location(br9, file$8, 61, 4, 2924);
    			attr_dev(div8, "class", "projectTitle svelte-r9uva9");
    			add_location(div8, file$8, 62, 4, 2935);
    			add_location(br10, file$8, 63, 4, 2989);
