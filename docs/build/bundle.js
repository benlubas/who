...
var app = (function () {
    ...
    class Noop extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$l, create_fragment$l, safe_not_equal, { scoped: 0 });
    ...
    const file$i = "node_modules/@roxi/routify/runtime/Prefetcher.svelte";
    ...
    function create_each_block$3(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(iframe, file$i, 80, 4, 2274);
    			this.first = iframe;
    		},
    		m: function mount(target, anchor) {
    ...
    function create_fragment$k(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$i, 78, 0, 2160);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$h = "node_modules/@roxi/routify/runtime/Route.svelte";
    ...
    function create_if_block$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$h, 133, 2, 4153);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    class Route extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$j, create_fragment$j, safe_not_equal, { nodes: 1, scoped: 0, decorator: 2 });
    ...
    class Router extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$i, create_fragment$i, safe_not_equal, { routes: 2, config: 3 });
    ...
    const file$g = "src/components/shape.svelte";
    ...
    function create_fragment$h(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$g, 117, 0, 3466);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$f = "src/components/PageTitle.svelte";
    ...
    function create_fragment$g(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$f, 6, 2, 177);
    			attr_dev(a, "href", a_href_value = /*$url*/ ctx[1]("/"));
    			add_location(a, file$f, 14, 2, 336);
    			add_location(br0, file$f, 15, 2, 379);
    			add_location(br1, file$f, 15, 8, 385);
    			attr_dev(div1, "class", "title-container");
    			add_location(div1, file$f, 5, 0, 145);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    class PageTitle extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$g, create_fragment$g, safe_not_equal, { title: 0 });
    ...
    function create_fragment$f(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$e, 12, 4, 520);
    			add_location(br0, file$e, 20, 4, 1022);
    			add_location(br1, file$e, 20, 11, 1029);
    			add_location(br2, file$e, 27, 4, 1340);
    			add_location(br3, file$e, 27, 11, 1347);
    			add_location(br4, file$e, 34, 4, 1653);
    			add_location(br5, file$e, 34, 11, 1660);
    			attr_dev(a0, "href", a0_href_value = /*$url*/ ctx[0]("/work"));
    			add_location(a0, file$e, 37, 4, 1752);
    			attr_dev(div1, "class", "subtitle");
    			add_location(div1, file$e, 43, 4, 2100);
    			add_location(strong0, file$e, 48, 8, 2271);
    			add_location(li0, file$e, 47, 6, 2258);
    			add_location(strong1, file$e, 53, 8, 2528);
    			add_location(li1, file$e, 52, 6, 2515);
    			add_location(strong2, file$e, 59, 8, 2856);
    			add_location(li2, file$e, 58, 6, 2843);
    			add_location(strong3, file$e, 65, 8, 3182);
    			add_location(li3, file$e, 64, 6, 3169);
    			add_location(strong4, file$e, 71, 8, 3504);
    			add_location(li4, file$e, 70, 6, 3491);
    			add_location(strong5, file$e, 77, 8, 3832);
    			add_location(li5, file$e, 76, 6, 3819);
    			add_location(strong6, file$e, 82, 8, 4108);
    			add_location(li6, file$e, 81, 6, 4095);
    			add_location(strong7, file$e, 87, 8, 4365);
    			add_location(li7, file$e, 86, 6, 4352);
    			add_location(strong8, file$e, 92, 8, 4597);
    			add_location(li8, file$e, 91, 6, 4584);
    			add_location(ul0, file$e, 46, 4, 2247);
    			attr_dev(div2, "class", "subtitle");
    			add_location(div2, file$e, 99, 4, 4898);
    			add_location(strong9, file$e, 105, 8, 5091);
    			add_location(li9, file$e, 104, 6, 5078);
    			add_location(strong10, file$e, 112, 8, 5478);
    			add_location(li10, file$e, 111, 6, 5465);
    			add_location(strong11, file$e, 120, 10, 5988);
    			add_location(li11, file$e, 120, 6, 5984);
    			add_location(strong12, file$e, 122, 8, 6078);
    			add_location(li12, file$e, 121, 6, 6065);
    			add_location(strong13, file$e, 126, 8, 6222);
    			add_location(li13, file$e, 125, 6, 6209);
    			add_location(ul1, file$e, 103, 4, 5067);
    			attr_dev(div3, "class", "subtitle");
    			add_location(div3, file$e, 132, 4, 6471);
    			attr_dev(a1, "href", "https://www.svelte.dev");
    			attr_dev(a1, "target", "_blank");
    			attr_dev(a1, "rel", "noopener noreferrer");
    			add_location(a1, file$e, 137, 4, 6821);
    			add_location(br6, file$e, 142, 4, 6951);
    			add_location(br7, file$e, 142, 11, 6958);
    			add_location(br8, file$e, 148, 4, 7194);
    			add_location(br9, file$e, 148, 11, 7201);
    			attr_dev(a2, "href", "https://routify.dev");
    			attr_dev(a2, "target", "_blank");
    			attr_dev(a2, "rel", "noopener noreferrer");
    			add_location(a2, file$e, 152, 4, 7363);
    			add_location(br10, file$e, 159, 4, 7689);
    			add_location(br11, file$e, 159, 10, 7695);
    			attr_dev(a3, "href", "https://www.github.com/benlubas/who");
    			attr_dev(a3, "target", "_blank");
    			attr_dev(a3, "rel", "noopener noreferrer");
    			add_location(a3, file$e, 163, 4, 7801);
    			attr_dev(div4, "class", "subtitle");
    			add_location(div4, file$e, 169, 4, 7927);
    			add_location(br12, file$e, 179, 4, 8616);
    			add_location(br13, file$e, 179, 11, 8623);
    			attr_dev(a4, "href", a4_href_value = /*$url*/ ctx[0]("/projects"));
    			add_location(a4, file$e, 182, 8, 8720);
    			attr_dev(div5, "class", "subtitle");
    			add_location(div5, file$e, 184, 4, 8773);
    			add_location(br14, file$e, 192, 4, 9274);
    			add_location(br15, file$e, 192, 11, 9281);
    			attr_dev(a5, "href", a5_href_value = /*$url*/ ctx[0]("/work"));
    			add_location(a5, file$e, 197, 31, 9560);
    			attr_dev(div6, "class", "text");
    			add_location(div6, file$e, 5, 2, 148);
    			attr_dev(div7, "class", "page-cont");
    			add_location(div7, file$e, 4, 0, 122);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$d = "src/components/textCarousel.svelte";
    ...
    function create_each_block$1(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			add_location(div, file$d, 7, 2, 195);
    			this.first = div;
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    ...
    class TextCarousel extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		init$1(this, options, instance$e, create_fragment$e, safe_not_equal, { list: 0 });
    ...
    const file$c = "src/components/gridBoxes/name.svelte";
    ...
    function create_fragment$d(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$c, 3, 0, 80);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$b = "src/components/gridBoxes/projectsBtn.svelte";
    ...
    function create_fragment$c(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$b, 5, 6, 107);
    			attr_dev(div1, "class", "btn-title");
    			add_location(div1, file$b, 6, 6, 132);
    			attr_dev(div2, "class", "box svelte-gju94k");
    			add_location(div2, file$b, 4, 4, 83);
    			attr_dev(div3, "class", "outer-box svelte-gju94k");
    			add_location(div3, file$b, 3, 2, 55);
    			attr_dev(div4, "class", "container svelte-gju94k");
    			add_location(div4, file$b, 2, 0, 29);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$a = "src/components/gridBoxes/aboutBtn.svelte";
    ...
    function create_fragment$b(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div0, file$a, 4, 4, 77);
    ...
    const file$9 = "src/components/gridBoxes/workBtn.svelte";
    ...
    const file$8 = "src/components/gridBoxes/githubBtn.svelte";
    ...
    function create_fragment$9(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "btn-title");
    			add_location(div0, file$8, 4, 4, 89);
    ...
    const file$7 = "src/components/gridBoxes/resumeBtn.svelte";
    ...
    function create_fragment$6(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "subtitle");
    			add_location(div0, file$5, 9, 4, 416);
    			add_location(br0, file$5, 16, 4, 875);
    			add_location(br1, file$5, 16, 10, 881);
    			add_location(br2, file$5, 27, 4, 1460);
    			add_location(br3, file$5, 27, 10, 1466);
    			add_location(br4, file$5, 34, 4, 1746);
    			add_location(br5, file$5, 34, 10, 1752);
    			add_location(br6, file$5, 43, 4, 2211);
    			add_location(br7, file$5, 43, 10, 2217);
    			add_location(br8, file$5, 49, 4, 2443);
    			add_location(br9, file$5, 49, 10, 2449);
    			add_location(br10, file$5, 58, 4, 2876);
    			add_location(br11, file$5, 58, 10, 2882);
    			add_location(br12, file$5, 64, 4, 3106);
    			add_location(br13, file$5, 64, 10, 3112);
    			attr_dev(div1, "class", "subtitle");
    			add_location(div1, file$5, 71, 4, 3373);
    			add_location(br14, file$5, 77, 4, 3703);
    			add_location(br15, file$5, 77, 10, 3709);
    			add_location(br16, file$5, 86, 4, 4184);
    			add_location(br17, file$5, 86, 10, 4190);
    			add_location(br18, file$5, 90, 4, 4319);
    			add_location(br19, file$5, 90, 10, 4325);
    			add_location(br20, file$5, 96, 4, 4640);
    			add_location(br21, file$5, 96, 10, 4646);
    			add_location(br22, file$5, 105, 4, 5076);
    			add_location(br23, file$5, 105, 10, 5082);
    			attr_dev(div2, "class", "subtitle");
    			add_location(div2, file$5, 114, 4, 5520);
    			add_location(br24, file$5, 121, 4, 6059);
    			add_location(br25, file$5, 121, 10, 6065);
    			add_location(br26, file$5, 123, 4, 6128);
    			add_location(br27, file$5, 123, 10, 6134);
    			add_location(br28, file$5, 128, 4, 6439);
    			add_location(br29, file$5, 129, 4, 6450);
    			add_location(br30, file$5, 139, 4, 7157);
    			add_location(br31, file$5, 140, 4, 7168);
    			add_location(br32, file$5, 144, 4, 7376);
    			add_location(br33, file$5, 144, 10, 7382);
    			add_location(br34, file$5, 147, 4, 7529);
    			add_location(br35, file$5, 147, 10, 7535);
    			attr_dev(div3, "class", "text");
    			add_location(div3, file$5, 4, 2, 111);
    			attr_dev(div4, "class", "page-cont");
    			add_location(div4, file$5, 3, 0, 85);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    const file$4 = "src/components/delimitedList.svelte";
    ...
    const file$3 = "src/components/delimitedListItem.svelte";
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			li = element("li");
    			if (default_slot) default_slot.c();
    			attr_dev(li, "class", "svelte-1xgyghz");
    			add_location(li, file$3, 2, 0, 29);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function create_if_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			if (/*availability*/ ctx[2] === void 0) add_render_callback(() => /*span_input_handler*/ ctx[11].call(span));
    			add_location(span, file$2, 105, 31, 3454);
    			attr_dev(div, "class", "availability");
    			add_location(div, file$2, 104, 10, 3396);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			append_dev(div, t);
    			...
    			if (/*availability*/ ctx[2] !== void 0) {
    				span.innerHTML = /*availability*/ ctx[2];
    			}
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*availability*/ 4 && /*availability*/ ctx[2] !== span.innerHTML) {
    				span.innerHTML = /*availability*/ ctx[2];
    			}
    		},
    		d: function destroy(detaching) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "if",
    		source: "(104:8) {#if showAvailability}",
    		ctx
    	});
    ...
    // (147:14) <DelimitedListItem>
    function create_default_slot_3(ctx) {
    	let t_value = /*skill*/ ctx[28] + "";
    	let t;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(147:14) <DelimitedListItem>",
    		ctx
    	});
    ...
    function create_each_block_4(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(146:12) {#each skills as skill}",
    		ctx
    	});
    ...
    // (155:14) <DelimitedListItem>
    function create_default_slot_1(ctx) {
    	let t_value = /*interest*/ ctx[25] + "";
    	let t;
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "slot",
    		source: "(155:14) <DelimitedListItem>",
    		ctx
    	});
    ...
    // (154:12) {#each interests as interest}
    function create_each_block_3(ctx) {
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(154:12) {#each interests as interest}",
    		ctx
    	});
    ...
    // (172:12) {#each job.bullets as bullet}
    function create_each_block_2(ctx) {
    	let li;
    	let t_value = /*bullet*/ ctx[22] + "";
    	let t;
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(li, file$2, 172, 14, 5792);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, li, anchor);
    			append_dev(li, t);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(172:12) {#each job.bullets as bullet}",
    		ctx
    	});
    ...
    // (163:6) {#each jobs as job}
    function create_each_block_1(ctx) {
    	let div3;
    	let div2;
    	let div0;
    	let strong;
    	let t0_value = /*job*/ ctx[19].title + "";
    	let t0;
    	let t1;
    	let t2_value = /*job*/ ctx[19].company + "";
    	let t2;
    	let t3;
    	let div1;
    	let t4_value = /*job*/ ctx[19].date + "";
    	let t4;
    	let t5;
    	let ul;
    	let t6;
    	let each_value_2 = /*job*/ ctx[19].bullets;
    	...
    	const block = {
    		c: function create() {
    			...
    			t6 = space();
    			add_location(strong, file$2, 166, 14, 5585);
    			attr_dev(div0, "class", "job-title");
    			add_location(div0, file$2, 165, 12, 5547);
    			attr_dev(div1, "class", "activity-date svelte-1n2eo4k");
    			add_location(div1, file$2, 168, 12, 5660);
    			attr_dev(div2, "class", "activity-heading svelte-1n2eo4k");
    			add_location(div2, file$2, 164, 10, 5504);
    			add_location(ul, file$2, 170, 10, 5731);
    			attr_dev(div3, "class", "job");
    			add_location(div3, file$2, 163, 8, 5476);
    		},
    		m: function mount(target, anchor) {
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*jobs*/ 256) {
    				each_value_2 = /*job*/ ctx[19].bullets;
    				validate_each_argument(each_value_2);
    				let i;
    ...
    // (181:6) {#each projects as project}
    function create_each_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(strong, file$2, 184, 14, 6134);
    			attr_dev(div0, "class", "job-title");
    			add_location(div0, file$2, 183, 12, 6096);
    			attr_dev(div1, "class", "activity-date svelte-1n2eo4k");
    			add_location(div1, file$2, 186, 12, 6222);
    			attr_dev(div2, "class", "activity-heading svelte-1n2eo4k");
    			add_location(div2, file$2, 182, 10, 6053);
    			attr_dev(li0, "class", "job-bullet");
    			add_location(li0, file$2, 189, 12, 6311);
    			attr_dev(li1, "class", "job-bullet");
    			add_location(li1, file$2, 193, 12, 6494);
    			add_location(ul, file$2, 188, 10, 6294);
    			attr_dev(div3, "class", "project");
    			add_location(div3, file$2, 181, 8, 6021);
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div3, anchor);
    			append_dev(div3, div2);
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(181:6) {#each projects as project}",
    		ctx
    	});
    ...
    function create_fragment$3(ctx) {
    	...
    	let mounted;
    	let dispose;
    	let if_block = /*showAvailability*/ ctx[1] && create_if_block(ctx);
    	...
    	const block = {
    		c: function create() {
    			...
    			t4 = space();
    			label = element("label");
    			label.textContent = "Show Availability";
    			t6 = space();
    			div33 = element("div");
    			div9 = element("div");
    			div4 = element("div");
    			...
    			t46 = space();
    			div28 = element("div");
    			div28.textContent = "Jan-Jun, 2020";
    			t48 = space();
    			ul = element("ul");
    			li0 = element("li");
    			...
    			add_location(p0, file$2, 79, 2, 2759);
    			add_location(p1, file$2, 83, 2, 2874);
    			attr_dev(input, "type", "checkbox");
    			attr_dev(input, "id", "showAvailability");
    			add_location(input, file$2, 88, 2, 3037);
    			attr_dev(label, "for", "showAvailability");
    			add_location(label, file$2, 93, 2, 3133);
    			attr_dev(div0, "class", "no-print svelte-1n2eo4k");
    			add_location(div0, file$2, 78, 0, 2734);
    			attr_dev(div1, "class", "name svelte-1n2eo4k");
    			add_location(div1, file$2, 100, 8, 3304);
    			attr_dev(div2, "class", "name-box svelte-1n2eo4k");
    			add_location(div2, file$2, 99, 6, 3273);
    			attr_dev(div3, "class", "resume-subtitle svelte-1n2eo4k");
    			attr_dev(div3, "contenteditable", "");
    			if (/*subtitle*/ ctx[0] === void 0) add_render_callback(() => /*div3_input_handler*/ ctx[12].call(div3));
    			add_location(div3, file$2, 112, 6, 3599);
    			attr_dev(div4, "class", "title-box");
    			add_location(div4, file$2, 98, 4, 3243);
    			attr_dev(div5, "class", "phone svelte-1n2eo4k");
    			attr_dev(div5, "contenteditable", "");
    			if (/*phone*/ ctx[3] === void 0) add_render_callback(() => /*div5_input_handler*/ ctx[13].call(div5));
    			add_location(div5, file$2, 115, 6, 3716);
    			attr_dev(div6, "class", "email svelte-1n2eo4k");
    			attr_dev(div6, "contenteditable", "");
    			if (/*email*/ ctx[4] === void 0) add_render_callback(() => /*div6_input_handler*/ ctx[14].call(div6));
    			add_location(div6, file$2, 116, 6, 3783);
    			attr_dev(div7, "class", "website svelte-1n2eo4k");
    			attr_dev(div7, "contenteditable", "");
    			if (/*website*/ ctx[5] === void 0) add_render_callback(() => /*div7_input_handler*/ ctx[15].call(div7));
    			add_location(div7, file$2, 117, 6, 3850);
    			attr_dev(div8, "class", "contact svelte-1n2eo4k");
    			add_location(div8, file$2, 114, 4, 3688);
    			attr_dev(div9, "class", "head svelte-1n2eo4k");
    			add_location(div9, file$2, 97, 2, 3220);
    			attr_dev(div10, "class", "r-section-title svelte-1n2eo4k");
    			add_location(div10, file$2, 123, 8, 4020);
    			add_location(strong0, file$2, 126, 12, 4152);
    			attr_dev(div11, "class", "activity-date svelte-1n2eo4k");
    			add_location(div11, file$2, 127, 12, 4205);
    			attr_dev(div12, "class", "activity-heading svelte-1n2eo4k");
    			add_location(div12, file$2, 125, 10, 4109);
    			add_location(p2, file$2, 129, 10, 4275);
    			add_location(p3, file$2, 130, 10, 4327);
    			add_location(p4, file$2, 131, 10, 4401);
    			attr_dev(div13, "class", "edu-section svelte-1n2eo4k");
    			add_location(div13, file$2, 124, 8, 4073);
    			add_location(strong1, file$2, 135, 12, 4539);
    			attr_dev(div14, "class", "activity-date svelte-1n2eo4k");
    			add_location(div14, file$2, 136, 12, 4600);
    			attr_dev(div15, "class", "activity-heading svelte-1n2eo4k");
    			add_location(div15, file$2, 134, 10, 4496);
    			add_location(p5, file$2, 138, 10, 4670);
    			attr_dev(div16, "class", "edu-section svelte-1n2eo4k");
    			add_location(div16, file$2, 133, 8, 4460);
    			attr_dev(div17, "id", "education");
    			add_location(div17, file$2, 122, 6, 3991);
    			attr_dev(div18, "class", "r-section-title svelte-1n2eo4k");
    			add_location(div18, file$2, 143, 10, 4820);
    			attr_dev(div19, "class", "tech-knowledge");
    			add_location(div19, file$2, 142, 8, 4781);
    			attr_dev(div20, "class", "r-section-title svelte-1n2eo4k");
    			add_location(div20, file$2, 151, 10, 5102);
    			attr_dev(div21, "class", "interests");
    			add_location(div21, file$2, 150, 8, 5068);
    			attr_dev(div22, "id", "knowledge-interests");
    			attr_dev(div22, "class", "svelte-1n2eo4k");
    			add_location(div22, file$2, 141, 6, 4742);
    			attr_dev(div23, "class", "top-body svelte-1n2eo4k");
    			add_location(div23, file$2, 121, 4, 3962);
    			attr_dev(div24, "class", "r-section-title svelte-1n2eo4k");
    			add_location(div24, file$2, 161, 6, 5391);
    			attr_dev(div25, "id", "work");
    			add_location(div25, file$2, 160, 4, 5369);
    			attr_dev(div26, "class", "r-section-title svelte-1n2eo4k");
    			add_location(div26, file$2, 179, 6, 5935);
    			add_location(strong2, file$2, 203, 12, 6817);
    			attr_dev(div27, "class", "job-title");
    			add_location(div27, file$2, 202, 10, 6781);
    			attr_dev(div28, "class", "activity-date svelte-1n2eo4k");
    			add_location(div28, file$2, 205, 10, 6900);
    			attr_dev(div29, "class", "activity-heading svelte-1n2eo4k");
    			add_location(div29, file$2, 201, 8, 6740);
    			attr_dev(li0, "class", "job-bullet");
    			add_location(li0, file$2, 208, 10, 6985);
    			attr_dev(li1, "class", "job-bullet");
    			add_location(li1, file$2, 212, 10, 7178);
    			add_location(ul, file$2, 207, 8, 6970);
    			attr_dev(div30, "class", "project");
    			add_location(div30, file$2, 200, 6, 6710);
    			attr_dev(div31, "id", "projects");
    			add_location(div31, file$2, 178, 4, 5909);
    			attr_dev(div32, "class", "r-body");
    			add_location(div32, file$2, 120, 2, 3937);
    			attr_dev(div33, "class", "resume svelte-1n2eo4k");
    			add_location(div33, file$2, 96, 0, 3197);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			input.checked = /*showAvailability*/ ctx[1];
    			append_dev(div0, t4);
    			...
    			mount_component(delimitedlist0, div19, null);
    			append_dev(div22, t34);
    			append_dev(div22, div21);
    			append_dev(div21, div20);
    			append_dev(div21, t36);
    			mount_component(delimitedlist1, div21, null);
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div3, "input", /*div3_input_handler*/ ctx[12]),
    					listen_dev(div5, "input", /*div5_input_handler*/ ctx[13]),
    					listen_dev(div6, "input", /*div6_input_handler*/ ctx[14]),
    					listen_dev(div7, "input", /*div7_input_handler*/ ctx[15])
    				];
    		...
    		p: function update(ctx, dirty) {
    			if (dirty[0] & /*showAvailability*/ 2) {
    				input.checked = /*showAvailability*/ ctx[1];
    			}

    			if (/*showAvailability*/ ctx[1]) {
    				if (if_block) {
    					if_block.p(ctx, dirty);
    				} else {
    			...
    			if (dirty[0] & /*subtitle*/ 1 && /*subtitle*/ ctx[0] !== div3.innerHTML) {
    				div3.innerHTML = /*subtitle*/ ctx[0];
    			}

    			if (dirty[0] & /*phone*/ 8 && /*phone*/ ctx[3] !== div5.innerHTML) {
    				div5.innerHTML = /*phone*/ ctx[3];
    			}

    			if (dirty[0] & /*email*/ 16 && /*email*/ ctx[4] !== div6.innerHTML) {
    				div6.innerHTML = /*email*/ ctx[4];
    			}

    			if (dirty[0] & /*website*/ 32 && /*website*/ ctx[5] !== div7.innerHTML) {
    				div7.innerHTML = /*website*/ ctx[5];
    			}
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	function input_change_handler() {
    		showAvailability = this.checked;
    		$$invalidate(1, showAvailability);
    	}

    	function span_input_handler() {
    		availability = this.innerHTML;
    		$$invalidate(2, availability);
    	}
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ('availability' in $$props) $$invalidate(2, availability = $$props.availability);
