...
var app = (function () {
    ...
    function create_fragment$a(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			a0 = element("a");
    			a0.textContent = "site";
    			t14 = text(" and you can look around.\n    ");
    			br8 = element("br");
    			t15 = space();
    			br9 = element("br");
    			...
    			add_location(div0, file$9, 11, 4, 538);
    			add_location(br0, file$9, 18, 4, 1089);
    			add_location(br1, file$9, 19, 4, 1100);
    			add_location(br2, file$9, 22, 4, 1257);
    			add_location(br3, file$9, 23, 4, 1268);
    			add_location(br4, file$9, 27, 4, 1483);
    			add_location(br5, file$9, 28, 4, 1494);
    			add_location(br6, file$9, 34, 4, 1807);
    			add_location(br7, file$9, 35, 4, 1818);
    			attr_dev(div1, "class", "subtitle");
    			add_location(div1, file$9, 41, 4, 2156);
    			attr_dev(a0, "href", "https://www.svelte.dev");
    			add_location(a0, file$9, 46, 4, 2506);
    			add_location(br8, file$9, 47, 4, 2578);
    			add_location(br9, file$9, 48, 4, 2589);
    			add_location(br10, file$9, 53, 4, 2894);
    			add_location(br11, file$9, 53, 10, 2900);
    			attr_dev(a1, "href", "https://routify.dev");
    			add_location(a1, file$9, 56, 4, 3061);
    			add_location(br12, file$9, 60, 4, 3337);
    			add_location(br13, file$9, 60, 10, 3343);
    			attr_dev(a2, "href", "https://www.github.com/benlubas/who");
    			add_location(a2, file$9, 64, 4, 3449);
    			attr_dev(div2, "class", "subtitle");
    			add_location(div2, file$9, 66, 4, 3510);
    			add_location(br14, file$9, 74, 4, 4097);
    			add_location(br15, file$9, 75, 4, 4108);
    			attr_dev(a3, "href", a3_href_value = /*$url*/ ctx[0]("/projects"));
    			add_location(a3, file$9, 77, 8, 4204);
    			attr_dev(div3, "class", "subtitle");
    			add_location(div3, file$9, 79, 4, 4257);
    			add_location(br16, file$9, 88, 4, 4901);
    			add_location(br17, file$9, 89, 4, 4912);
    			add_location(br18, file$9, 95, 4, 5236);
    			add_location(br19, file$9, 96, 4, 5247);
    			attr_dev(a4, "href", a4_href_value = /*$url*/ ctx[0]("/courses"));
    			add_location(a4, file$9, 98, 4, 5320);
    ...
    const file$7 = "src/components/textCarosel.svelte";
    ...
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		c: function create() {
    			...
    			t0 = text(t0_value);
    			t1 = space();
    			attr_dev(div, "class", "carosel-text svelte-p6ywup");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "subtitle");
    			add_location(div0, file, 9, 4, 417);
    			attr_dev(div1, "class", "subtitle");
    			add_location(div1, file, 13, 4, 629);
    			attr_dev(div2, "class", "subtitle");
    			add_location(div2, file, 16, 4, 750);
    			add_location(br0, file, 23, 4, 1289);
    			add_location(br1, file, 23, 10, 1295);
    			add_location(br2, file, 25, 4, 1358);
    			add_location(br3, file, 25, 10, 1364);
    			add_location(br4, file, 30, 4, 1669);
    			add_location(br5, file, 31, 4, 1680);
    			add_location(br6, file, 41, 4, 2387);
    			add_location(br7, file, 42, 4, 2398);
    			add_location(br8, file, 46, 4, 2606);
    			add_location(br9, file, 46, 10, 2612);
    			add_location(br10, file, 49, 4, 2759);
    			add_location(br11, file, 49, 10, 2765);
